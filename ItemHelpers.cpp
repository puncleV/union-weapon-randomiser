...
namespace GOTHIC_ENGINE {
	...
	std::vector < Loot > CHESTS_LOOT_TABLE = {
		Loot(5, 1000, false, { "ITPO_PERM_DEF" }),
		Loot(7, 1000, false, { "ITPO_NP_STATS" }),
		Loot(10, 1000, false, { "ITPO_FIREDEFENCE", "ITPO_MAGDEFENCE" }),
		Loot(10, 1000, false, { "ITMI_POTIONPERMBLANK", "ITPO_INTELLECT", "ITPO_ELIXIRSHADOW", "ITSC_TRFDRAGONSNAPPER", "ITPL_PERM_HERB", "ITPO_NP_MANAREG3", "ITPO_PERM_MANA"}),
		Loot(10, 1000, true, {
			"ITRU_BELIARSRAGE",
			"ITRU_ICEEXPLOISION",
			"ITRU_SUMMONGUARDIAN",
		...
		Loot(10, 1000, true, { "ITRI_ORE_DIAM", "ITRI_ORE_EMER", "ITRI_ORE_SAPP", "ITRI_ORE_OPAL", "ITRI_ORE_TOPA", "ITRI_ORE_RUBY" }),
		Loot(10, 1000, false, { "ITFO_CAKE_MUSHROOM", "ITFO_CAKE_FISH", "ITFO_CAKE_APPLE", "ITFO_CAKE_MEAT", "ITFO_CAKE_HONEY", "ITFO_EALBALZAM", "ITFO_EALBALZAMTWO", "ITPL_PERM_HERB", "ITMI_JEWELERYCHEST", "ITPO_HEALTH_03", "ITPO_MANA_03", "ITPO_NP_MANAREG2", "ITPO_NP_STAMINA" }),
		Loot(10, 1000, true, { "ITRI_GOLD_DIAM", "ITRI_GOLD_EMER", "ITRI_GOLD_SAPP", "ITRI_GOLD_OPAL", "ITRI_GOLD_TOPA", "ITRI_GOLD_RUBY" }),
		Loot(10, 1000, true, { "ITRI_STEEL_DIAM", "ITRI_STEEL_EMER", "ITRI_STEEL_SAPP", "ITRI_STEEL_OPAL", "ITRI_STEEL_TOPA", "ITRI_STEEL_RUBY", "ITRI_NEW_OREMASTER", "ITRI_NEW_MANAREGEN", "ITRI_HP_PARLAN" }),
		Loot(50, 1000, false, { "ITPO_NP_MANAREG3", "ITPO_NP_MANAREG2", "ITPO_NP_STAMINA", "ITPO_HEALTH_03", "ITPO_HEALTH_02", "ITPO_MANA_03", "ITPO_MANA_02", "ITRW_ADDON_MAGICARROW", "ITRW_ADDON_MAGICBOLT", "ITSC_RESSURECT", "ITSC_UNLOCK", "ITSC_ICECUBE" }),
		Loot(15, 1000, true, {
			"ITRU_INSTANTFIREBALL",
			"ITRU_STONEFIRST",
			"ITRU_ICELANCE",
		...
		Loot(50, 1000, true, { "ITBE_ADDON_MIL_01", "ITBE_ADDON_SLD_01", "ITBE_ADDON_NOV_01", "ITBE_ADDON_SEK_01", "ITBE_ADDON_THIEF_01",
			"ITBE_ADDON_THIEF_02", "ITBE_ADDON_STR_10", "ITBE_ADDON_DEX_10", "ITAM_DEX_01", "ITAM_STRG_01", "ITRI_MANA_02", "ITBE_ADDON_SEK_01",
			"ITBE_ADDON_PROT_EDGE", "ITBE_ADDON_PROT_POINT", "ITBE_ADDON_PROT_MAGIC", "ITBE_ADDON_PROT_FIRE", "ITBE_ADDON_PROT_EDGPOI", "ITBE_ADDON_PROT_TOTAL",
			"ITBE_ADDON_CUSTOM_01", "ITBE_ADDON_CUSTOM_02", "ITBE_ADDON_CUSTOM_03",
			"ITBE_ADDON_CUSTOM_04",
		...
		Loot(70, 1000, true, { "ITWR_ADDON_RUNEMAKING_KDW_CIRC1", "ITWR_ADDON_RUNEMAKING_KDW_CIRC2", "ITWR_ADDON_RUNEMAKING_KDW_CIRC3", "ITWR_ADDON_RUNEMAKING_KDW_CIRC4", "ITWR_ADDON_RUNEMAKING_KDW_CIRC5",
			"ITWR_ADDON_RUNEMAKING_KDF_CIRC1", "ITWR_ADDON_RUNEMAKING_KDF_CIRC2", "ITWR_ADDON_RUNEMAKING_KDF_CIRC3", "ITWR_ADDON_RUNEMAKING_KDF_CIRC4", "ITWR_ADDON_RUNEMAKING_KDF_CIRC5",
			"ITWR_ADDON_RUNEMAKING_GUR_CIRC1", "ITWR_ADDON_RUNEMAKING_GUR_CIRC2", "ITWR_ADDON_RUNEMAKING_GUR_CIRC3", "ITWR_ADDON_RUNEMAKING_GUR_CIRC4", "ITWR_ADDON_RUNEMAKING_GUR_CIRC5",
			"ITWR_ADDON_RUNEMAKING_DMT_CIRC1", "ITWR_ADDON_RUNEMAKING_DMT_CIRC2", "ITWR_ADDON_RUNEMAKING_DMT_CIRC3", "ITWR_ADDON_RUNEMAKING_DMT_CIRC4", "ITWR_ADDON_RUNEMAKING_DMT_CIRC5",
			"ITWR_ADDON_RUNEMAKING_PRM", "ITWR_ORCLANGUAGE", "ITWR_ALCHEMY_01", "ITWR_BOWBETTERSHOT", "ITWR_BLOODFLY_01", "ITWR_GOLDMAKE", "ITWR_JAGD_UND_BEUTE",
		...
		Loot(210, 1000, false, { "ITPO_SPEED_03", "ITPO_HEALTH_01", "ITPO_MANA_01", "ITRW_ADDON_MAGICARROW",
			"ITRW_EXPLOSIVEBOLT", "ITRW_BOLT", "ITRW_ARROW", "ITFO_BREAD", "ITAT_CLAW", "ITPL_BEET", "ITSC_TRFWOLF", "ITSC_TRFSCAVENGER", "ITSC_SLEEP", "ITPL_MUSHROOM_02",
			"ITSC_TRFLURKER", "ITSC_TRFSNAPPER", "ITSC_SUMGOBSKEL", "ITFO_HONEY"
		}),
		Loot(650, 1000, false, {  "ITMI_GOLD", "ITPL_BEET", "ITRW_ADDON_MAGICARROW", "ITRW_EXPLOSIVEBOLT", "ITRW_BOLT", "ITRW_ARROW", "ITFO_BEER", "ITFO_APPLE", "ITFO_BREAD", "ITFO_BOOZE", "ITFO_WATER",
			"ITFO_WINE", "ITFO_WINEBERRYS", "ITFO_SCHILDKROETESOUP_SBORKA", "ITFO_ADDON_RUM", "ITFO_ADDON_SHELLFLESH", "ITFO_SMELLYFISH", "ITWR_STONEPLATECOMMON_ADDON", "ITAT_CLAW",
			"ITSC_SUMWOLF", "ITSC_SUMGOBSKEL", "ITPL_MANA_HERB_01", "ITPL_HEALTH_HERB_01", "ITPL_MUSHROOM_01", "ITPL_BLUEPLANT",
			"ITPL_FORESTBERRY", "ITPL_PLANEBERRY", "ITMI_SNUGGET", "ITFO_HONEY"
		})
	};
	...
	auto bossLoot = Loot(600, 1000, false, { "ITPO_AMUNSU", "ITPO_MEGADRINK", "ITPO_ELIGORFIRE", "ITPO_WATERFIRE", "ITPO_RAREPOTION_01", "ITPO_RAREPOTION_02", "ITPO_RAREPOTION_03",
		"ITPO_RAREPOTION_04", "ITPO_RAREPOTION_05", "ITPO_RAREPOTION_06", "ITPO_RAREPOTION_07", "ITPO_RAREPOTION_08"
		});

	auto alchemistLoot = Loot(800, 1000, false, { "ITPO_FIREDEFENCE", "ITPO_MAGDEFENCE", "ITPO_AMUNSU", "ITPO_MEGADRINK", "ITPO_ELIGORFIRE", "ITPO_WATERFIRE", "ITPO_INTELLECT", "ITPO_NP_STATS", "ITPL_PERM_HERB", "ITPO_NP_MANAREG3", "ITPO_PERM_MANA" });

	auto magicLoot = Loot(1000, 1000, false, {
			"ITRU_BELIARSRAGE",
			"ITRU_ICEEXPLOISION",
			"ITRU_SUMMONGUARDIAN",
			"ITRU_SUMGOL",
